...
const allGuessHeadings = document.querySelectorAll(".game__main--guess-heading");
const correctHeadings = document.querySelectorAll(".game__main--correct-heading");
const correctContinentHeading = document.querySelectorAll(".game__main--continent-heading");
